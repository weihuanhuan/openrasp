...
public class JSTokenizeSql extends BaseFunction {
    ...
    public Object call(Context cx, Scriptable scope, Scriptable thisObj,
        ...
        Object javaObject = Context.jsToJava(args[0], String.class);
        if (!(javaObject instanceof String)) {
            return Context.getUndefinedValue();
        }

        String sql = (String) javaObject;
        ArrayList<TokenResult> result = TokenGenerator.detailTokenize(sql, tokenizeErrorListener);
