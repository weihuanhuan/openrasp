...
public class JSContext extends Context {
    ...
    public static final String PARAM_STACK_KEY = "stack";
    ...
    public void fillParamStack(CheckParameter checkParameter) {
        if (checkParameter == null) {
            return;
        }

        Map params = checkParameter.getParams();
        if (params == null || params.containsKey(PARAM_STACK_KEY)) {
            return;
        }

        List<String> stackTraceArray = StackTrace.getParamStackTraceArray();
        params.put(PARAM_STACK_KEY, stackTraceArray);
    }
